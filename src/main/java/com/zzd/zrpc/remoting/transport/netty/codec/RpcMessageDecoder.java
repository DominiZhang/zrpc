 ...
 *   |                                        ... ...                                                        |
 *   +-------------------------------------------------------------------------------------------------------+
 * 4B  magic code（魔法数）   1B version（版本）   4B full length（消息长度） include header  1B messageType（消息类型）
 ...
 * @author zzd
 * @date 2023/1/11
 * @see <a href="https://zhuanlan.zhihu.com/p/95621344">LengthFieldBasedFrameDecoder解码器</a> TODO
 */
@Slf4j
public class RpcMessageDecoder extends LengthFieldBasedFrameDecoder {
    ...
    private void checkMagicNumber(ByteBuf in) {
        // read 4 bit, which is the magic number, then compare
